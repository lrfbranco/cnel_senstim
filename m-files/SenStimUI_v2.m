...
classdef SenStimUI_v2 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function CheckUpdateFrontEndDropDown(app)
            ...
            switch value
                case 'Macro'
                    stepSizeArr = [1 2 10 20 50 120];  % <= Change here if Ripple changes stepSizes
                case 'Micro'
    ...
    methods (Access = private)
        ...
        % DurationsEditField, FrequencyHzEditField, 
        % FrontEndDropDown, InterburstLengthmsEditField, 
        % InterpulseWidthsEditField, ListBoxBipolarElectrodes, 
        % ListBoxStimElectrodes, PreStimWaitmsEditField, 
        % PulseWidthsEditField, StepSizeDropDown
        ...
        % Drop down opening function: StepSizeDropDown
